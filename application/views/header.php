...
<html>
	...
	<nav>
            <a href="<?php echo base_url(); ?>index.php/" class=<?php if($this->router->fetch_method() == "index") echo "current" ?>  >HOME</a>
            <a href="<?php echo base_url(); ?>index.php/movies/" class=<?php if($this->router->fetch_method() == "movies") echo "current" ?>    >NOW&nbsp;SHOWING</a>
            <a href="<?php echo base_url(); ?>index.php/price/" class=<?php if($this->router->fetch_method() == "price") echo "current" ?>	>SCHEDULE&nbsp;&&nbsp;PRICES</a>
            <a href="<?php echo base_url(); ?>index.php/contact/" class=<?php if($this->router->fetch_method() == "contact") echo "current" ?>	>CONTACT</a>
	</nav>
